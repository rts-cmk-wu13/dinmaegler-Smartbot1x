...
export function setupGlassNavEffect(navSelector, filterSelector, textSelector) {
    const nav = document.querySelector(navSelector);
    const effectEl = document.querySelector(filterSelector);
    ...
    nav.querySelectorAll('li').forEach(($el, idx) => {
